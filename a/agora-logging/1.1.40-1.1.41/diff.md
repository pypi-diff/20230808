# Comparing `tmp/agora_logging-1.1.40-py2.py3-none-any.whl.zip` & `tmp/agora_logging-1.1.41-py2.py3-none-any.whl.zip`
...
+-rw-r--r--  2.0 fat       25 b- defN 23-Aug-08 17:47 agora_logging/version.py
...
+-rw-r--r--  2.0 fat      134 b- defN 23-Jun-14 11:28 agora_logging-1.1.41.dist-info/LICENSE
+-rw-r--r--  2.0 fat       99 b- defN 16-Jan-01 00:00 agora_logging-1.1.41.dist-info/WHEEL
+-rw-r--r--  2.0 fat      898 b- defN 16-Jan-01 00:00 agora_logging-1.1.41.dist-info/METADATA
+-rw-r--r--  2.0 fat     1012 b- defN 16-Jan-01 00:00 agora_logging-1.1.41.dist-info/RECORD
...
+Filename: agora_logging-1.1.41.dist-info/LICENSE
 Comment: 
 
-Filename: agora_logging-1.1.40.dist-info/WHEEL
+Filename: agora_logging-1.1.41.dist-info/WHEEL
 Comment: 
 
-Filename: agora_logging-1.1.40.dist-info/METADATA
+Filename: agora_logging-1.1.41.dist-info/METADATA
 Comment: 
 
-Filename: agora_logging-1.1.40.dist-info/RECORD
+Filename: agora_logging-1.1.41.dist-info/RECORD
 Comment: 
...
## Comparing `agora_logging-1.1.40.dist-info/METADATA` & `agora_logging-1.1.41.dist-info/METADATA`
...
## Comparing `agora_logging-1.1.40.dist-info/RECORD` & `agora_logging-1.1.41.dist-info/RECORD`
...
+agora_logging/version.py,sha256=aEbzo-pQcEdWrp4kPt10RhUcWPxILUkGMOgYXQh9cBU,25
...
+agora_logging-1.1.41.dist-info/LICENSE,sha256=R-TdODMyhPUhIFgVHS3Y973VNriIq35ZLKQ6iTN2ySo,134
+agora_logging-1.1.41.dist-info/WHEEL,sha256=Sgu64hAMa6g5FdzHxXv9Xdse9yxpGGMeagVtPMWpJQY,99
+agora_logging-1.1.41.dist-info/METADATA,sha256=0uK5qnyNijl7aFVebC7C9Ti79ayavYAl7Ms85DgGvFo,898
+agora_logging-1.1.41.dist-info/RECORD,,
```
