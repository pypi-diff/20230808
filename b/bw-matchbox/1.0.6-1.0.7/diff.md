# Comparing `tmp/bw_matchbox-1.0.6.tar.gz` & `tmp/bw_matchbox-1.0.7.tar.gz`
...
### Comparing `bw_matchbox-1.0.6/bw_matchbox/webapp.py` & `bw_matchbox-1.0.7/bw_matchbox/webapp.py`
