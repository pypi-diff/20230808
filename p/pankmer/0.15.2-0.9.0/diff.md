# Comparing `tmp/pankmer-0.15.2.tar.gz` & `tmp/pankmer-0.9.0.tar.gz`
...
## Comparing `pankmer-0.15.2.tar` & `pankmer-0.9.0.tar`

### file list

```diff
@@ -1,34 +1,34 @@
--rw-r--r--   0        0        0      588 1970-01-01 00:00:00.000000 pankmer-0.15.2/rust/Cargo.toml
--rw-r--r--   0      501       20     2636 2023-08-08 03:25:02.000000 pankmer-0.15.2/rust/src/adj_matrix.rs
--rw-r--r--   0      501       20     3544 2023-07-14 06:20:11.000000 pankmer-0.15.2/rust/src/decompose_kmers.rs
--rw-r--r--   0      501       20    14112 2023-08-08 19:30:35.000000 pankmer-0.15.2/rust/src/get_kmers.rs
--rw-r--r--   0      501       20     4070 2023-08-08 05:07:46.000000 pankmer-0.15.2/rust/src/helpers.rs
--rw-r--r--   0      501       20     9199 2023-08-03 04:51:56.000000 pankmer-0.15.2/rust/src/lib.rs
--rw-r--r--   0      501       20     3921 2023-08-08 19:30:35.000000 pankmer-0.15.2/rust/src/measure.rs
--rw-r--r--   0      501       20     2667 2023-07-14 06:20:11.000000 pankmer-0.15.2/rust/src/mem_blocks.rs
--rw-r--r--   0      501       20     4577 2023-08-08 19:30:35.000000 pankmer-0.15.2/rust/src/metadata.rs
--rw-r--r--   0      501       20    14813 2023-08-08 05:07:46.000000 pankmer-0.15.2/rust/src/pkidx.rs
--rw-r--r--   0      501       20    11723 2023-08-08 19:30:35.000000 pankmer-0.15.2/rust/src/subset_index.rs
--rw-r--r--   0      501       20     1160 2023-08-08 19:30:35.000000 pankmer-0.15.2/pyproject.toml
--rw-r--r--   0      501       20    32404 2023-08-08 19:10:05.000000 pankmer-0.15.2/rust/Cargo.lock
--rw-r--r--   0      501       20     1313 2023-07-24 00:08:48.000000 pankmer-0.15.2/src/pankmer/parse_genomes_input.py
--rw-r--r--   0      501       20     8227 2023-08-08 03:25:02.000000 pankmer-0.15.2/src/pankmer/tree.py
--rw-r--r--   0      501       20     6157 2023-08-03 04:51:56.000000 pankmer-0.15.2/src/pankmer/collect.py
--rw-r--r--   0      501       20       58 2023-05-28 17:15:47.000000 pankmer-0.15.2/src/pankmer/version.py
--rw-r--r--   0      501       20      583 2023-08-03 04:51:56.000000 pankmer-0.15.2/src/pankmer/env.py
--rw-r--r--   0      501       20     3699 2023-08-08 03:25:02.000000 pankmer-0.15.2/src/pankmer/clustermap.py
--rw-r--r--   0      501       20    18607 2023-08-08 03:25:02.000000 pankmer-0.15.2/src/pankmer/anchor.py
--rw-r--r--   0      501       20      214 2023-05-19 03:56:34.000000 pankmer-0.15.2/src/pankmer/get_lower_bound.py
--rw-r--r--   0      501       20     6288 2023-08-03 04:51:56.000000 pankmer-0.15.2/src/pankmer/download.py
--rw-r--r--   0      501       20    33386 2023-08-03 04:51:56.000000 pankmer-0.15.2/src/pankmer/datasets.py
--rw-r--r--   0      501       20      337 2023-08-08 16:56:47.000000 pankmer-0.15.2/src/pankmer/__init__.py
--rw-r--r--   0      501       20     1683 2023-08-03 04:51:56.000000 pankmer-0.15.2/src/pankmer/adjacency_matrix.py
--rw-r--r--   0      501       20     1801 2023-08-03 04:51:56.000000 pankmer-0.15.2/src/pankmer/upset.py
--rw-r--r--   0      501       20      603 2023-07-17 05:50:46.000000 pankmer-0.15.2/src/pankmer/subset.py
--rw-r--r--   0      501       20      947 2023-07-14 06:20:11.000000 pankmer-0.15.2/src/pankmer/gzip_agnostic_open.py
--rw-r--r--   0      501       20     3278 2023-08-08 03:25:02.000000 pankmer-0.15.2/src/pankmer/anchormap.py
--rw-r--r--   0      501       20      772 2023-08-03 04:51:56.000000 pankmer-0.15.2/src/pankmer/count.py
--rw-r--r--   0      501       20     2617 2023-07-24 00:08:48.000000 pankmer-0.15.2/src/pankmer/dryrun.py
--rw-r--r--   0      501       20    63455 2023-08-08 16:56:47.000000 pankmer-0.15.2/src/pankmer/pankmer.py
--rw-r--r--   0      501       20     8366 2023-08-08 03:25:02.000000 pankmer-0.15.2/README.md
--rw-r--r--   0        0        0     9377 1970-01-01 00:00:00.000000 pankmer-0.15.2/PKG-INFO
...
### Comparing `pankmer-0.15.2/pyproject.toml` & `pankmer-0.9.0/pyproject.toml`
...
+build-backend = "setuptools.build_meta"
 ...
 [project]
 name = "pankmer"
-version = "0.15.2" # Don't forget to match with Cargo.toml and docs/source/conf.py
...
### Comparing `pankmer-0.15.2/src/pankmer/tree.py` & `pankmer-0.9.0/src/pankmer/tree.py`
...
### Comparing `pankmer-0.15.2/src/pankmer/clustermap.py` & `pankmer-0.9.0/src/pankmer/clustermap.py`
...
### Comparing `pankmer-0.15.2/src/pankmer/anchor.py` & `pankmer-0.9.0/src/pankmer/reg_coverage.py`
...
### Comparing `pankmer-0.15.2/src/pankmer/adjacency_matrix.py` & `pankmer-0.9.0/src/pankmer/adjacency_matrix.py`
...
### Comparing `pankmer-0.15.2/src/pankmer/count.py` & `pankmer-0.9.0/src/pankmer/count.py`
...
### Comparing `pankmer-0.15.2/src/pankmer/pankmer.py` & `pankmer-0.9.0/src/pankmer/pankmer.py`
