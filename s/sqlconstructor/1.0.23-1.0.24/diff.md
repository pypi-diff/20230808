# Comparing `tmp/sqlconstructor-1.0.23.tar.gz` & `tmp/sqlconstructor-1.0.24.tar.gz`
...
### Comparing `sqlconstructor-1.0.23/src/sqlconstructor/constants.py` & `sqlconstructor-1.0.24/src/sqlconstructor/constants.py`
