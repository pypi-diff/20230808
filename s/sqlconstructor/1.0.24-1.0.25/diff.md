# Comparing `tmp/sqlconstructor-1.0.24.tar.gz` & `tmp/sqlconstructor-1.0.25.tar.gz`
...
### Comparing `sqlconstructor-1.0.24/src/sqlconstructor/cols.py` & `sqlconstructor-1.0.25/src/sqlconstructor/cols.py`
