# Comparing `tmp/sqlconstructor-1.0.25.tar.gz` & `tmp/sqlconstructor-1.0.26.tar.gz`
...
### Comparing `sqlconstructor-1.0.25/src/sqlconstructor/cols.py` & `sqlconstructor-1.0.26/src/sqlconstructor/cols.py`
