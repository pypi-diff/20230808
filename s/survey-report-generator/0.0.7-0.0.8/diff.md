# Comparing `tmp/survey_report_generator-0.0.7.tar.gz` & `tmp/survey_report_generator-0.0.8.tar.gz`
...
### Comparing `survey_report_generator-0.0.7/README.md` & `survey_report_generator-0.0.8/README.md`
